...
echo $persyaratan['nama_dokumen']."</div>";

$data_meta = $this->M_user2->data_meta_where($persyaratan['no_nama_dokumen']);
echo"<div class='card-body'>";    
foreach ($data_meta->result_array() as $inputan){
echo "<labe>".$inputan['nama_meta']."</label>"
. "<input type='text' placeholder='".$inputan['nama_meta']."' class='form-control form-control-sm'>";  
}
echo "</div>";
echo"<div class='card-footer'>";    
echo "<button onclick=regis_js('".$persyaratan['no_nama_dokumen']."'); class='btn btn-sm btn-dark btn-block simpan_form".$persyaratan['no_nama_dokumen']."'>Rekam Data</button>";    
echo "</div></div>";
