...
<div class="text-center" style="padding:0.890rem 1rem; background-color:darkcyan; font-size:16px">
    <a href="<?php echo base_url('User3'); ?>"><span style="color:#fff;">Divisi Perizinan</span></a>
...
<li>
<a class="list-group-item list-group-item-action " href="<?php echo base_url('User3/halaman_proses') ?>">Sedang dikerjakan <i class="fa fa-arrow-right float-right"></i></a>
</li>
<li>
