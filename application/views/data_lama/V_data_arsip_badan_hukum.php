...
<h5 align="center " class="text-theme1"><span class="fa-3x far fa-building"></span><br>Data Client Peroangan</h5>
</div>
...
processing: true,
serverSide: true,
ajax: {"url": "<?php echo base_url('Data_lama/json_data_arsip_badan_hukum') ?> ", 
"type": "POST",
data: function ( d ) {
