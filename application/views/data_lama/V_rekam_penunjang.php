...
url:"<?php echo base_url('Data_lama/tampilkan_data_perizinan') ?>",
success:function(data){
...
url:"<?php echo base_url('Data_lama/hapus_pemilik') ?>",
success:function(data){
response(data);
refresh();
}
...
window.location.href="<?php echo base_url('Data_lama/download_berkas/') ?>"+id_data_berkas;
}
...
window.location.href = "<?php echo base_url('Data_lama/pekerjaan_proses/'); ?>";
});
