...
$.ajax({
type:"post",
url:"<?php echo base_url('data_lama/update_user')?>",
...
window.location.href='<?php echo base_url('data_lama/profil') ?>';    
});   
...
$.ajax({
type:"post",
url:"<?php echo base_url('data_lama/update_password')?>",
...
processData: false,
contentType: false,
url:"<?php echo base_url('data_lama/simpan_profile'); ?>",
data:formData,
success:function(data){
