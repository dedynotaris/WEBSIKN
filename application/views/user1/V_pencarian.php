...
url:"<?php echo base_url('User1/cek_download_berkas') ?>",
success:function(data){
var r = JSON.parse(data);
if(r.status == 'success'){
window.location.href = '<?php echo base_url('User1/download_berkas/') ?>'+no_berkas;   
}else{
...
window.location.href="<?php echo base_url('User1/download_utama/'); ?>"+id 
}
...
url:"<?php echo base_url('User1/data_perekaman_pencarian') ?>",
success:function(data){
...
url:"<?php echo base_url('User1/data_perekaman_utama') ?>",
success:function(data){
$('#data_perekaman').modal('show');  
$(".modal-dialog").html(data);
}})
