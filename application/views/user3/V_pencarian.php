...
url:"<?php echo base_url('User3/cek_download_berkas') ?>",
success:function(data){
var r = JSON.parse(data);
if(r.status == 'success'){
window.location.href = '<?php echo base_url('User3/download_berkas/') ?>'+no_berkas;   
}else{
...
window.location.href="<?php echo base_url('User3/download_utama/'); ?>"+id 
}

function lihat_berkas_client(no_client){   
window.location.href="<?php echo base_url($this->uri->segment(1)."/lihat_lampiran_client/") ?>"+no_client;    
}    
...
url:"<?php echo base_url('User3/data_perekaman_pencarian') ?>",
success:function(data){
...
url:"<?php echo base_url('User3/data_perekaman_utama') ?>",
success:function(data){
$('#data_perekaman').modal('show');  
$(".modal-dialog").html(data);
}})
