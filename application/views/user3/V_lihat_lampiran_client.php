...
url:"<?php echo base_url('User3/lihat_meta') ?>",
...
url:"<?php echo base_url('User3/update_meta') ?>",
success:function(data){
read_response(data);
...
processing: true,
serverSide: true,
ajax: {"url": "<?php echo base_url('User3/json_data_lampiran_client/'.$this->uri->segment(3))?> ", 
"type": "POST",
data: function ( d ) {
