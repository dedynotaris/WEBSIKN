...
?>
<div class="container ">    
<div class="card-header mt-2 mb-2 text-center text-info">
HALAMAN UNTUK MEMBUAT PERIZINAN <?php echo $static['nama_client'] ?>
<button class="btn btn-dark btn-sm float-md-right "  onclick="lanjutkan_proses_selesai('<?php echo $this->uri->segment(3) ?>');">Selesaikan pekerjaan <span class="fa fa-check"></span></button>
</div>
...
<hr>
<div class="row">
<div class="col-md-6"><button  onclick=form_edit_client("<?php echo base64_encode($static['no_client']) ?>"); class="btn btn-block btn-dark btn-sm ">Edit client  <span class="fa fa-edit"></span></button></div>    
<div class="col-md-6"><button onclick=tampilkan_form("<?php echo $static['no_client'] ?>","<?php echo $this->uri->segment(3) ?>"); class="btn btn-block btn-dark btn-sm ">Rekam Penunjang  <span class="fa fa-plus"></span></button></div>    
<div class="col-md-6 mt-2"><button  onclick=tampilkan_form_utama("<?php echo $static['no_client'] ?>","<?php echo $this->uri->segment(3) ?>"); class='btn  btn-block btn-dark btn-sm   ' title='Rekam dokumen utama' >Rekam Utama <span class='fa fa-plus'></span> </button></div>    
<div class="col-md-6 mt-2"><button  onclick=tampilkan_form_perizinan("<?php echo $static['no_client'] ?>","<?php echo $this->uri->segment(3) ?>"); class='btn  btn-block btn-dark btn-sm   ' title='Rekam dokumen utama' >Buat Perizinan <span class='fa fa-plus'></span> </button></div>    
</div>
</div>
...
<hr>
<button onclick=update_pekerjaan(); class="btn btn-dark btn-sm btn-block">Perbaharui Jenis Pekerjaan <span class="fa fa-edit"></span></button>    
</div>
</div>
...
<div class="card">
<div class="card-header bg-info text-white text-center">Form Penambahan Pihak Terlibat</div>
<div class="card-body">
...
<button type="button" onclick="simpan_pihak();" class="btn btn-sm btn-dark btn-block"> Tambahkan pihak yang terlibat <span class="fa fa-user"></span></button>
...
<div class="col text-theme1 m-1 ">
<div class="card">
<div class=" card-body  p-2 para_pihak">
...
<!--------------- laporanperizinan --------------->    
<div class="modal fade" id="modallaporanperizinan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog modal-md modal-dialog-scrollable" role="document">
<div class="modal-content datalaporanperizinan ">
...
success:function(data){
$(".datalaporanperizinan").html(data);    
$('#modallaporanperizinan').modal('show');
}
});
}
