...
window.location.href="<?php echo base_url('User2/download_utama/'); ?>"+id 
}
...
url:"<?php echo base_url('User2/data_perekaman_pencarian') ?>",
success:function(data){
...
url:"<?php echo base_url('User2/data_perekaman_utama') ?>",
success:function(data){
$('#data_perekaman').modal('show');  
$(".modal-dialog").html(data);
}})
