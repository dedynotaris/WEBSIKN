...
<button class="btn btn-dark btn-sm float-md-right "  onclick="lanjutkan_proses_perizinan('<?php echo $this->uri->segment(3) ?>');">Proses Pembuatan Penunjang <span class="fa fa-arrow-right"></span></button>
</div>
