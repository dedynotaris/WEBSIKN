...
<hr>
<button type="button"  onclick="simpan_pekerjaan();" class="btn btn-dark  mx-auto btn-block simpan_perizinan">Buat Pekerjaan Baru <i class="fa fa-save"></i></button>
...
$.ajax({
url  : "<?php echo base_url("User2/SimpanArsip") ?>",
type : "post",
data : data,
dataType:"JSON",
success: function(data) {
...
$('.select2 + p').remove();
$.ajax({
url  : "<?php echo base_url("User2/SimpanEditKontak") ?>",
type : "post",
...
$.ajax({
type:"post",
url:"<?php echo base_url('User2/FormEditKontak') ?>",
data:"token="+token+"&id_kontak="+id_kontak,
success:function(data){
$(".data_modal").html(data);    
$('#modal').modal('show');
